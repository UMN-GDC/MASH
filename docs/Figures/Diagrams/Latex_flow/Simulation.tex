...
\node[dnode,above=  of anc_freq, fill=red!30] (Genetic){
	Gene inputs
	\nodepart{second}
	nSNPs	
	};
...
\node (gene_assign) [tnode, fill = yellow!30, below left = of site_anc_assign] {
	Gene assignment
	\nodepart{second}
...
\node (pheno) [tnode, fill = green!30, right = of gene_eff] {
	Phenotype
	\nodepart{second}
