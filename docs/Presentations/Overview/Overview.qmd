---
title: "Heritability of regional volumes in the adolescent brain"
...
![Subcortical regions highlighted in red](figures/Subcortical_regions.png){alt="Subcortical regions highlighted in red data-id"}

*Imaged generated at theanatomyoflove.com*
...
![Heritability across brain including subcortical](figures/UKB_herit.jpeg){alt="Heritability across brain including subcortical data-id"}
...
![Trajectory](figures/UKB_trajectory.jpeg)
...
-   Largest adolescent dataset with imaging and genetics

-   Taken over 22 sites

-   Confounding with scanner and site effects

-   No heritability estimators currently adjust for these effects

## AdjHE extension accounts for site effects

-   AdjHE estimator is variance component estimator
...
-   Partition variance between Genetic relatedness matrix ($\sigma_G^2$) and unmodeled variance ($\sigma_E^2$)
...
-   No need for $S\perp GRM$

## Outperforms existing methods adjusting for site effects

-   Other estimators necessitate $S\perp GRM$
-   Up to 4 times faster computations
-   More speed gains to come

![Simulation comparisons](figures/Adding_sites_n_clusts_het.png)
...
![Heritability estimates](figures/AdjHE_RE_brain.png)
...
-   United a host of site adjustment methods for heritability estimation

-   Also simulates phenotypes from existing or simulated GWAS data

![Simulation diagram](figures/simulation_diagram.png)
